...
public class Main extends Application {
	...
	/*
	 * public static void main(String[] args) { FrequencyCounter fc = new
	 * FrequencyCounter("input.txt"); fc.readFile();
	 * 
	 * String fileContent = fc.getFileContent(); HashMap<Character, Integer>
	 ...
	 * 
	 * huffman.compress(frequencies); for (Entry<Character, String> entry :
	 * huffman.getCodes().entrySet()) { System.out.println("Character: " + (int)
	 ...
	 * System.out.println("Character: " + (int) entry.getKey() + " Frequency: " +
	 * entry.getValue()); }
	 * 
	 * 
	 * }
